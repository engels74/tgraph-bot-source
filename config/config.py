...
CONFIGURABLE_OPTIONS = [
    'LANGUAGE', 'UPDATE_DAYS', 'FIXED_UPDATE_TIME', 'KEEP_DAYS', 'TIME_RANGE_DAYS', 'CENSOR_USERNAMES',
...
def save_config(config, config_path=CONFIG_PATH, default_config=None):
    ...
    if os.path.exists(config_path):
        ...
        new_keys = [key for key in default_config if key not in existing_keys and key in config]
