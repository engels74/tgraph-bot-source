...
class TestSchedulerCog(BaseCommandCog):
    ...
    @app_commands.command(
        name="test_scheduler",
        description=i18n.translate("Test the scheduled update functionality immediately")
    )
    ...
    async def test_scheduler(self, interaction: discord.Interaction) -> None:
        ...
        try:
            ...
            _ = status_embed.add_field(
                ...
                value=(f"**Update Interval:** {config.UPDATE_DAYS} day(s)\n"
            ...
            if next_update_before:
                _ = status_embed.add_field(
                    ...
                    value=(f"**Last Update:** {last_update_before.strftime('%Y-%m-%d %H:%M:%S') if last_update_before else 'Never'}\n"
            ...
            if last_update_after and last_update_after != last_update_before:
                _ = success_embed.add_field(
                    ...
                    value=(f"**Last Update:** Updated to {last_update_after.strftime('%Y-%m-%d %H:%M:%S')}\n"
            ...
            _ = success_embed.add_field(
                ...
                value=i18n.translate("The scheduler will work correctly at the configured time. All timing calculations and update workflows are functioning properly."),
                inline=False
            )
            ...
            error_embed = create_error_embed(
                ...
                description=i18n.translate("The scheduled update test encountered an error")
            )
            ...
            _ = error_embed.add_field(
                ...
                value=i18n.translate("There may be an issue with:\n• Tautulli API connectivity\n• Discord channel permissions\n• Graph generation process\n• Bot configuration"),
                inline=False
            )
            _ = error_embed.add_field(
                name=i18n.translate("Next Steps"),
                value=i18n.translate("Check the bot logs for detailed error information and verify your configuration settings."),
                inline=False
            )
            ...
            await self.handle_command_error(
                ...
                e,
                "test_scheduler",
                {"scheduler_status": status_before}
            )
