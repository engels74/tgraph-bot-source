...
This package contains all Discord slash commands for the TGraph Bot, with each command
implemented as a separate Cog in its own module. This ensures clean separation of concerns
and maintains a structured codebase.
