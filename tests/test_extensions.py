...
class TestExtensionFunctions:
    ...
    async def test_load_extensions(self) -> None:
        ...
        with patch("bot.extensions._extension_manager.discover_extensions") as mock_discover, \
             patch("bot.extensions._extension_manager.load_extension_safe") as mock_load_safe:
    ...
    async def test_unload_extensions(self) -> None:
        ...
        with patch("bot.extensions._extension_manager.discover_extensions") as mock_discover, \
             patch("bot.extensions.unload_extension_safe") as mock_unload_safe:
    ...
    async def test_unload_extension_safe_success(self) -> None:
        ...
        with patch("bot.extensions._extension_manager.mark_extension_unloaded") as mock_mark:
    ...
    async def test_reload_extension_success(self) -> None:
        ...
        with patch("bot.extensions._extension_manager.mark_extension_loaded") as mock_mark:
    ...
    async def test_reload_all_extensions(self) -> None:
        ...
        with patch("bot.extensions._extension_manager.get_loaded_extensions") as mock_get_loaded, \
             patch("bot.extensions.reload_extension") as mock_reload:
    ...
    def test_get_extension_info(self) -> None:
        ...
        with patch("bot.extensions._extension_manager.discover_extensions") as mock_discover, \
             patch("bot.extensions._extension_manager.is_extension_loaded") as mock_is_loaded, \
             patch("bot.extensions._extension_manager.get_extension_error") as mock_get_error:
    ...
    def test_get_loaded_extensions_function(self) -> None:
        ...
        with patch("bot.extensions._extension_manager.get_loaded_extensions") as mock_get:
    ...
    def test_get_failed_extensions_function(self) -> None:
        ...
        with patch("bot.extensions._extension_manager.get_failed_extensions") as mock_get:
