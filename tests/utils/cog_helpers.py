...
def assert_cog_has_commands(cog: commands.Cog, expected_commands: list[str]) -> None:
    ...
    for expected_command in expected_commands:
        assert expected_command in cog_commands, f"Command '{expected_command}' not found in cog"


def assert_cog_has_attributes(cog: commands.Cog, expected_attributes: list[str]) -> None:
    """
