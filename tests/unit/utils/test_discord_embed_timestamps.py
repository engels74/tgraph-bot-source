...
class TestTimestampConsistency:
    ...
    def test_update_days_properly_applied_to_timestamps(self, base_time: datetime) -> None:
        ...
        expected_next_update = datetime.combine(expected_date, datetime.strptime("23:59", "%H:%M").time())
...
class TestBugFix:
    ...
    def test_update_days_1_scenario_matches_scheduler_state(self) -> None:
        ...
        expected_next = datetime(2025, 7, 26, 23, 59, 0, tzinfo=ZoneInfo("Europe/Copenhagen"))
