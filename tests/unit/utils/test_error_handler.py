...
class TestErrorContext:
    ...
    def test_error_context_to_dict(self) -> None:
        ...
        context = ErrorContext(
            user_id=123, command_name="test", additional_context={"test": True}
        )
...
class TestErrorHandling:
    ...
    async def test_handle_command_error(self) -> None:
        ...
        async with async_mock_context(
            "src.tgraph_bot.utils.core.error_handler.send_error_response",
            return_value=True,
        ) as mock_send:
...
class TestErrorDecorators:
    ...
    async def test_command_error_handler_decorator(self) -> None:
        ...
        async with async_mock_context(
            "src.tgraph_bot.utils.core.error_handler.handle_command_error"
        ) as mock_handle:
