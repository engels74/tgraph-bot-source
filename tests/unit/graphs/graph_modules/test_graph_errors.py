...
class TestErrorMessageTemplates:
    ...
    def test_all_templates_format_correctly(self) -> None:
        ...
        test_params = {
            ...
            "invalid_data_format": {"data_context": "test", "expected": "dict", "actual": "list"},
            "empty_dataset": {},
            ...
            "file_write_error": {"path": "/tmp/test.png", "reason": "permission denied"},
            "validation_failed": {"validation_type": "dimensions", "reason": "size mismatch"},
        }
