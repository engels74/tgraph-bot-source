...
class TestGraphTypeRegistry:
    ...
    def test_get_type_name_from_class(self) -> None:
        ...
        assert registry.get_type_name_from_class(DailyPlayCountGraph) == "daily_play_count"
    ...
    def test_is_valid_type(self) -> None:
        ...
        assert registry.is_valid_type("ENABLE_DAILY_PLAY_COUNT") is False  # This is an enable key, not type name
