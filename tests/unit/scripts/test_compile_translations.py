...
from src.tgraph_bot.utils.i18n.i18n_utils import compile_po_to_mo
...
""",
        ...
        return {"en": en_po, "da": da_po, "locale_dir": locale_dir}
    ...
    def test_compile_file_success(self, tmp_path: Path) -> None:
        ...
        with patch(
            "scripts.i18n.compile_translations.compile_po_to_mo"
        ) as mock_compile:
