...
class TestStartupSequence:
    ...
    async def test_post_initial_graphs_success(self, startup_sequence: StartupSequence, mock_bot: MagicMock, mock_config: TGraphBotConfig) -> None:
        ...
        # Mock GraphManager
        with patch('src.tgraph_bot.bot.startup_sequence.GraphManager') as mock_graph_manager_class:
            ...
            # Mock file utilities
            with patch('src.tgraph_bot.bot.startup_sequence.validate_file_for_discord') as mock_validate:
                with patch('src.tgraph_bot.bot.startup_sequence.create_discord_file_safe') as mock_create_file:
                    with patch('src.tgraph_bot.bot.startup_sequence.create_graph_specific_embed') as mock_create_embed:
