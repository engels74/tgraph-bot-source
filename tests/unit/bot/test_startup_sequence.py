...
class TestStartupSequence:
    ...
    @pytest.mark.asyncio
    async def test_startup_sequence_initialization(self, startup_sequence, mock_bot):
    ...
    @pytest.mark.asyncio
    async def test_cleanup_previous_messages_success(self, startup_sequence, mock_bot, mock_config):
    ...
    @pytest.mark.asyncio
    async def test_cleanup_previous_messages_no_channel(self, startup_sequence, mock_bot, mock_config):
    ...
    @pytest.mark.asyncio
    async def test_cleanup_handles_rate_limits(self, startup_sequence, mock_bot, mock_config):
    ...
    @pytest.mark.asyncio
    async def test_post_initial_graphs_success(self, startup_sequence, mock_bot, mock_config):
    ...
    @pytest.mark.asyncio
    async def test_update_scheduler_state(self, startup_sequence, mock_bot):
    ...
    @pytest.mark.asyncio
    async def test_update_scheduler_state_skips_if_no_graphs(self, startup_sequence):
    ...
    @pytest.mark.asyncio
    async def test_full_startup_sequence(self, startup_sequence):
    ...
    @pytest.mark.asyncio
    async def test_startup_sequence_continues_on_error(self, startup_sequence):
    ...
    def test_is_completed(self, startup_sequence):
